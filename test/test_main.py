...
# old_pos2 = 7
#
# print("Test 1 | opponent_tris = " + str(opponent_tris))
# print(unlock_opponent_tris(opponent_tris, old_pos1))
#
# print("Test 2 | opponent_tris = " + str(opponent_tris))
# print(unlock_opponent_tris(opponent_tris, old_pos2))
